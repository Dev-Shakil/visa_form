...
<body>
  @include('layout.navbar')
    <div class="w-[60%] mx-auto shadow-lg rounded-lg pb-2 mt-4">
      ...
      <div class="py-2 px-4 text-xl font-semibold w-full rounded-lg shadow-md text-[#082F2C] bg-[#ADCCC8]">Enter Issued Visa Information</div>
            ...
            <div class="w-full mt-3">
                ...
                <div class="py-2 flex flex-col gap-2">
                    <label for="embassy_visa_no" class="font-bold text-lg">
                      Embassy Visa No <span class="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      id="embassy_visa_no"
                      name="embassy_visa_no"
                  ...
                  <div class="py-2 flex flex-col gap-2">
                    <label for="issued_visa_date" class="font-bold text-lg">
                      Issued Visa Date <span class="text-red-500">*</span>
                    </label>
                    <input
                      type="date"
                      id="issued_visa_date"
                      name="issued_visa_date"
                  ...
                  <div class="py-2 flex flex-col gap-2">
                    <label for="issued_visa_expire_date" class="font-bold text-lg">
                      Issued Visa Expire Date <span class="text-red-500">*</span>
                    </label>
                    <input
                      type="date"
                      id="issued_visa_expire_date"
                      name="issued_visa_expire_date"
                      class="form-control p-2 rounded-lg w-full"
                      required
                      placeholder=""
                    />
