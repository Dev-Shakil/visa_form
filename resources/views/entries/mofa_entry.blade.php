...
<body>
  @include('layout.navbar')
    <div class="w-[60%] mx-auto shadow-lg rounded-lg pb-2 mt-4">
      ...
      <div class="py-2 px-4 text-xl font-semibold w-full rounded-lg shadow-md text-[#082F2C] bg-[#ADCCC8]">Enter Mofa Information</div>
        ...
        <form id="medicalInput" class="pt-4">
          ...
          <div class="w-full flex flex-col justify-center items-center">
            ...
            <div class="w-full mt-3">
               ...
               <!-- Mofa Date -->
            <div class="py-2 flex flex-col gap-2">
                <label for="mofa_date" class="font-bold text-lg">
                Mofa Date <span class="text-red-500">*</span>
                </label>
                <input
                type="date"
                id="mofa_date"
            ...
            <!-- Application Mofa No -->
            <div class="py-2 flex flex-col gap-2">
                <label for="application_mofa_no" class="font-bold text-lg">
                Application Mofa No <span class="text-red-500">*</span>
                </label>
                <input
                type="text"
                id="application_mofa_no"
                name="application_mofa_no"
