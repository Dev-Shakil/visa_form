...
<body>
  @include('layout.navbar')
    <div class="w-[60%] mx-auto shadow-lg rounded-lg pb-2 mt-4">
      ...
      <div class="py-2 px-4 text-xl font-semibold w-full rounded-lg shadow-md text-[#082F2C] bg-[#ADCCC8]">Enter Delivery Information</div>
          ...
          <div class="w-full flex flex-col justify-center items-center">
            ...
            <div class="w-full mt-3">
                ...
                <div class="px-10 gap-x-10 grid md:grid-cols-2">
                  ...
                  <div class="py-2 flex flex-col gap-2">
                    <label for="delivery_date" class="font-bold text-lg">
                  ...
                  <div class="py-2 flex flex-col gap-2">
                    <label for="delivery_note" class="font-bold text-lg">
                      Delivery Note <span class="text-red-500">*</span>
                    </label>
                    <textarea
                      row="3"
                      type="textarea"
